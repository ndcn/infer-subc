...
def _run_local_threshold(
    ...
    if volumetric:
        ...
        t_local = _get_adaptive_threshold(image_data, method,
                                threshold_operation=threshold_operation, 
                                automatic=automatic, 
                                two_class_otsu=two_class_otsu, 
                                assign_mid_to_fg = assign_mid_to_fg,
                                adaptive_window_size=adaptive_window_size)
    retval = img_as_float(t_local)
    return retval
...
def get_threshold_robust_background(image_data,num_dev = 3., lower_fraction=0.05, upper_fraction=0.05):
    """
